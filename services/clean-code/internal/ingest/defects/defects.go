...
//     HTTP handler layer ([forge/services/clean-code/internal/ingest/webhook.DefectsVerbHandler])
...
// row 4.
//
// JSON tags are populated so the [forge/services/clean-code/internal/ingest/webhook.DefectsVerbHandler]
