...
// Parser is an alias-like interface matching LanguageParser so
// that the global RegisterParser / SelectParser registry and the
// Dispatcher can share a single type. Any LanguageParser
// implementation also satisfies Parser.
